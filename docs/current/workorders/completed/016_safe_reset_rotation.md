...
- Text `Probar quaternion` (`796D1FB7-42B7-4B52-90D0-9379EC2BB951`) reset from
  `[0.9659258127212524, 0, 0, 0.258819043636322]` to `[0, 0, 0, 1]`.
- Video `v11 dorado.png` (`680CB8B6-CA66-4D15-AC15-0A92FC3E89FE`) reset from
  `[0.9659258127212524, 0, 0, 0.258819043636322]` to `[0, 0, 0, 1]`.
- Camera `v6 Camare1` (`EE632A41-FB3B-4CFA-BC27-00A4CEC54692`) reset from
  `[0.9659258127212524, 0, 0, 0.258819043636322]` to `[0, 0, 0, 1]`.
