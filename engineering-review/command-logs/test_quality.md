...
```sh
sed -n '1,260p' /Users/filarmonica/.codex/skills/codebase-inspection/SKILL.md
```

6.

```sh
sed -n '1,260p' /Users/filarmonica/.codex/skills/verification-before-completion/SKILL.md
```

7.

```sh
rg -n -i 'automated tests|test quality|pytest|write_mode|transport' /Users/filarmonica/.codex/memories/MEMORY.md | head -n 80
```
...
```sh
nl -ba /Users/filarmonica/.codex/memories/MEMORY.md | sed -n '140,166p;432,448p'
```

63.

```sh
nl -ba /Users/filarmonica/.codex/memories/MEMORY.md | sed -n '110,140p;410,432p'
```

64.

```sh
nl -ba /Users/filarmonica/.codex/memories/MEMORY.md | sed -n '80,112p'
```
