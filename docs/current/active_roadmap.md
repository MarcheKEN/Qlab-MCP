...
Video Phase 3E — Text Basics. Candidate scope for later only:
...
Phase 3D is runtime validated and closed. Keep blocked:
...
- text, text-format, `doOpacity`, and clock-type real writes
