...
rg -n -i "OSC Dictionary|QLab 5\.5|address-embedded|multiple workspaces|deprecated" <MEMORY_PATH>
sed -n '1,240p' <CODEX_HOME>/skills/qlab-docs-assistant/references/official-source-map.md
sed -n '1,280p' <ATTACHMENT_PATH>
wc -l <ATTACHMENT_PATH>
sed -n '281,760p' <ATTACHMENT_PATH>
nl -ba <MEMORY_PATH> | sed -n '232,370p'
sed -n '761,980p' <ATTACHMENT_PATH>
