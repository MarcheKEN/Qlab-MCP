...
```text
sed -n '1,240p' <CODEX_HOME>/skills/qlab-docs-assistant/SKILL.md

sed -n '1,240p' <CODEX_HOME>/skills/qlab-docs-assistant/references/official-source-map.md

sed -n '1,260p' <ATTACHMENT_PATH>

sed -n '261,620p' <ATTACHMENT_PATH>

sed -n '621,980p' <ATTACHMENT_PATH>

rg -n -i "documentation maintenance|QClass|developer experience|packaging|project direction|public write surface|README|pyproject|startup|operator friction" <MEMORY_PATH>

sed -n '79,158p' <MEMORY_PATH> && sed -n '35,76p' <MEMORY_PATH> && sed -n '215,254p' <MEMORY_PATH>
...
nl -ba <ROLLOUT_PATH> | sed -n '1,120p'; nl -ba <MEMORY_PATH> | sed -n '79,158p'
```
