...
(`95F0A03D-140E-4673-974A-E76748EBB023`) for `layer` with
...
- `Video` `v11 dorado.png` (`680CB8B6-CA66-4D15-AC15-0A92FC3E89FE`):
  `1000 -> 11 -> 1000`
- `Camera` `v6 Camare1` (`EE632A41-FB3B-4CFA-BC27-00A4CEC54692`):
  `1000 -> 11 -> 1000`
- `Text` `v1 Text1` (`193FB551-7985-4381-9C2D-CF4218C03FB9`):
  `1000 -> 11 -> 1000`
