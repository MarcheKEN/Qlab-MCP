...
sed -n '521,860p' <ATTACHMENT_PATH>

sed -n '861,1160p' <ATTACHMENT_PATH>

sed -n '1,260p' <CODEX_HOME>/skills/codebase-orientation/SKILL.md

rg -n -i "OSC transport|UDP|TCP|pending request|receiver|late repl|duplicate repl|runtime behavior|concurr" <MEMORY_PATH>
